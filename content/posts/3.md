...
And I got back this HUGE wall of HTML, JSON, CSS all the stuff. Well it turns out Grok's whole IOS/Android/Car app with the voice stuff actually has descriptions and prompts for them! And they are hilarious, I don't who Xai hired as prompt engineers, but they were feeling... **creative**.
...
It's truncated a bit, because it's **LONG**. The examples are... cringe worthy to say the least. I also translated the japanese with Google Translate for none japanese speakers (me being one of them):
"
...
Now there is a lot of boring ones like assistant and therapists but we will be looking at the ones label mature!
...
"<br>
<br>
That pinky musta been hurting. Whoever wrote this definitely was angry and someone.
...
"<br>
<br>
Okay, thats... something. I don't the get the all caps text, though I guess I'm not a {{<rainbow>}}Prompt Engineer{{</rainbow>}}
...
"<br>
<br>
It gets more dull really, though the "persona presets" are pretty good. And you get see them! I'm linking the file for you to see! Enjoy cringing s'more too.
# Files
<a href="/grok-stuff.json" download="grok-stuff.json" style="font-weight: bold;">Download grok-stuff.json (80 KB)</a>  

PS. Sorry that this is so long, It was a lot of JESON, long JESON (primegen got me saying that)